    ...
    <div className="relative">
      ...
      >
        ...
        <div className="relative z-10 flex h-full items-center justify-center">
          ...
          {isTabOpen && (
            <span
              className="absolute h-1 w-1 rounded-full bg-[#328be5]"
              style={{ left: -6 }}
            />
          )}
        </div>
        ...
        >
          <span
            className={cn(
              'min-w-0 flex-1 inline-flex items-center text-sm leading-4 whitespace-nowrap overflow-hidden text-ellipsis text-[#18191a]'
            )}
          >
            {item.name}
          </span>
